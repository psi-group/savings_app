  ...
  return (
    <div className="flex w-full h-full">
              ...
              <>
                <div className="flex gap-5">
                  ...
                  <div className="flex flex-col">
                    <h1 className="font-bold italic text-xl tracking-wide">{cartItem.itemName}</h1>
                    ...
                    <button className="self-start text-sm text-zinc-500" onClick={() => props.removeCartItem(index)}>Remove</button>
                  </div>
                </div>
      ...
      <div className="bg-sky-700 w-1/3 min-h-screen p-10 pt-24 flex flex-col gap-3">
        ...
        <h1 className="text-white text-2xl justify-self-end ">Total </h1>
        <div className="bg-white h-1 mt-2"></div>
        <button
          type="button"
